    ...
    */
    (function () {
        ...
        for (B = H.length; l < B; ++l)(function () {
            ...
            g.src = "/common/prettify/lang/lang-" + encodeURIComponent(H[l]) + ".js";
            N.insertBefore(g, N.firstChild)
        })(H[l]);
        for (var S = H.length, F = [], l = 0, B = P.length; l < B; ++l) F.push("/common/prettify/skins/" + encodeURIComponent(P[l]) + ".css");
